...
export default function Signup() {
  ...
  const inputClass =
    "w-full bg-input border border-border rounded-xl px-4 py-2.5 text-foreground placeholder:text-muted-foreground transition-all duration-200 focus:outline-none focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/10";
        ...
        <form onSubmit={handleSignup} className="glass-card p-8 space-y-4">
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/login" className="text-amber-500 hover:text-amber-400 font-medium transition-colors">Sign in</Link>
            </p>
          </div>
        </form>
      </div>
